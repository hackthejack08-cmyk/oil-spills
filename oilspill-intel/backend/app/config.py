...
WIND_DEFLECTION_DEG = (10.0, 20.0)    # Ekman/Coriolis deflection of wind-induced drift: right of wind in NH, left in SH
                                      # (starting configuration; literature 0–25°, e.g. NOAA ADIOS/GNOME, Reed et al. 1994)
